...
#define ASC_LOAD_GLFN(name) name = (pfn_##name)SDL_GL_GetProcAddress( #name );\
 if(!name) {ASC_Error("Failed to load GLFunction: %s", #name); return 0;}

bool ASC_LoadGLFunctions(i32 gl_ver_maj, i32 gl_ver_min);
...
static bool ASC_LoadGLFunctions(i32 gl_ver_maj, i32 gl_ver_min)
{
    r32 version = ((r32)gl_ver_maj + ((r32)gl_ver_min * 0.1f));

    if(version >= 1.0)
    {
        ASC_LOAD_GLFN(glCullFace);
        ASC_LOAD_GLFN(glFrontFace);
        ASC_LOAD_GLFN(glHint);
        ASC_LOAD_GLFN(glLineWidth);
        ASC_LOAD_GLFN(glPointSize);
        ASC_LOAD_GLFN(glPolygonMode);
        ASC_LOAD_GLFN(glScissor);
        ASC_LOAD_GLFN(glTexParameterf);
        ASC_LOAD_GLFN(glTexParameterfv);
        ASC_LOAD_GLFN(glTexParameteri);
        ASC_LOAD_GLFN(glTexParameteriv);
        ASC_LOAD_GLFN(glTexImage1D);
        ASC_LOAD_GLFN(glTexImage2D);
        ASC_LOAD_GLFN(glDrawBuffer);
        ASC_LOAD_GLFN(glClear);
        ASC_LOAD_GLFN(glClearColor);
        ASC_LOAD_GLFN(glClearStencil);
        ASC_LOAD_GLFN(glClearDepth);
        ASC_LOAD_GLFN(glStencilMask);
        ASC_LOAD_GLFN(glColorMask);
        ASC_LOAD_GLFN(glDepthMask);
        ASC_LOAD_GLFN(glDisable);
        ASC_LOAD_GLFN(glEnable);
        ASC_LOAD_GLFN(glFinish);
        ASC_LOAD_GLFN(glFlush);
        ASC_LOAD_GLFN(glBlendFunc);
        ASC_LOAD_GLFN(glLogicOp);
        ASC_LOAD_GLFN(glStencilFunc);
        ASC_LOAD_GLFN(glStencilOp);
        ASC_LOAD_GLFN(glDepthFunc);
        ASC_LOAD_GLFN(glPixelStoref);
        ASC_LOAD_GLFN(glPixelStorei);
        ASC_LOAD_GLFN(glReadBuffer);
        ASC_LOAD_GLFN(glReadPixels);
        ASC_LOAD_GLFN(glGetBooleanv);
        ASC_LOAD_GLFN(glGetDoublev);
        ASC_LOAD_GLFN(glGetError);
        ASC_LOAD_GLFN(glGetFloatv);
        ASC_LOAD_GLFN(glGetIntegerv);
        ASC_LOAD_GLFN(glGetString);
        ASC_LOAD_GLFN(glGetTexImage);
        ASC_LOAD_GLFN(glGetTexParameterfv);
        ASC_LOAD_GLFN(glGetTexParameteriv);
        ASC_LOAD_GLFN(glGetTexLevelParameterfv);
        ASC_LOAD_GLFN(glGetTexLevelParameteriv);
        ASC_LOAD_GLFN(glIsEnabled);
        ASC_LOAD_GLFN(glDepthRange);
        ASC_LOAD_GLFN(glViewport);
    }
    
    if(version >= 1.1)
    {
        ASC_LOAD_GLFN(glDrawArrays);
        ASC_LOAD_GLFN(glDrawElements);
        ASC_LOAD_GLFN(glPolygonOffset);
        ASC_LOAD_GLFN(glCopyTexImage1D);
        ASC_LOAD_GLFN(glCopyTexImage2D);
        ASC_LOAD_GLFN(glCopyTexSubImage1D);
        ASC_LOAD_GLFN(glCopyTexSubImage2D);
        ASC_LOAD_GLFN(glTexSubImage1D);
        ASC_LOAD_GLFN(glTexSubImage2D);
        ASC_LOAD_GLFN(glBindTexture);
        ASC_LOAD_GLFN(glDeleteTextures);
        ASC_LOAD_GLFN(glGenTextures);
        ASC_LOAD_GLFN(glIsTexture);
    }
    
    if(version >= 1.2)
    {
        ASC_LOAD_GLFN(glDrawRangeElements);
        ASC_LOAD_GLFN(glTexImage3D);
        ASC_LOAD_GLFN(glTexSubImage3D);
        ASC_LOAD_GLFN(glCopyTexSubImage3D);
    }
    
    if(version >= 1.3)
    {
        ASC_LOAD_GLFN(glActiveTexture);
        ASC_LOAD_GLFN(glSampleCoverage);
        ASC_LOAD_GLFN(glCompressedTexImage3D);
        ASC_LOAD_GLFN(glCompressedTexImage2D);
        ASC_LOAD_GLFN(glCompressedTexImage1D);
        ASC_LOAD_GLFN(glCompressedTexSubImage3D);
        ASC_LOAD_GLFN(glCompressedTexSubImage2D);
        ASC_LOAD_GLFN(glCompressedTexSubImage1D);
        ASC_LOAD_GLFN(glGetCompressedTexImage);
    }
    
    if(version >= 1.4)
    {
        ASC_LOAD_GLFN(glBlendFuncSeparate);
        ASC_LOAD_GLFN(glMultiDrawArrays);
        ASC_LOAD_GLFN(glMultiDrawElements);
        ASC_LOAD_GLFN(glPointParameterf);
        ASC_LOAD_GLFN(glPointParameterfv);
        ASC_LOAD_GLFN(glPointParameteri);
        ASC_LOAD_GLFN(glPointParameteriv);
        ASC_LOAD_GLFN(glBlendColor);
        ASC_LOAD_GLFN(glBlendEquation);
    }
    
    if(version >= 1.5)
    {
        ASC_LOAD_GLFN(glGenQueries);
        ASC_LOAD_GLFN(glDeleteQueries);
        ASC_LOAD_GLFN(glIsQuery);
        ASC_LOAD_GLFN(glBeginQuery);
        ASC_LOAD_GLFN(glEndQuery);
        ASC_LOAD_GLFN(glGetQueryiv);
        ASC_LOAD_GLFN(glGetQueryObjectiv);
        ASC_LOAD_GLFN(glGetQueryObjectuiv);
        ASC_LOAD_GLFN(glBindBuffer);
        ASC_LOAD_GLFN(glDeleteBuffers);
        ASC_LOAD_GLFN(glGenBuffers);
        ASC_LOAD_GLFN(glIsBuffer);
        ASC_LOAD_GLFN(glBufferData);
        ASC_LOAD_GLFN(glBufferSubData);
        ASC_LOAD_GLFN(glGetBufferSubData);
        ASC_LOAD_GLFN(glMapBuffer);
        ASC_LOAD_GLFN(glUnmapBuffer);
        ASC_LOAD_GLFN(glGetBufferParameteriv);
        ASC_LOAD_GLFN(glGetBufferPointerv);
    }
    
    if(version >= 2.0)
    {
        ASC_LOAD_GLFN(glBlendEquationSeparate);
        ASC_LOAD_GLFN(glDrawBuffers);
        ASC_LOAD_GLFN(glStencilOpSeparate);
        ASC_LOAD_GLFN(glStencilFuncSeparate);
        ASC_LOAD_GLFN(glStencilMaskSeparate);
        ASC_LOAD_GLFN(glAttachShader);
        ASC_LOAD_GLFN(glBindAttribLocation);
        ASC_LOAD_GLFN(glCompileShader);
        ASC_LOAD_GLFN(glCreateProgram);
        ASC_LOAD_GLFN(glCreateShader);
        ASC_LOAD_GLFN(glDeleteProgram);
        ASC_LOAD_GLFN(glDeleteShader);
        ASC_LOAD_GLFN(glDetachShader);
        ASC_LOAD_GLFN(glDisableVertexAttribArray);
        ASC_LOAD_GLFN(glEnableVertexAttribArray);
        ASC_LOAD_GLFN(glGetActiveAttrib);
        ASC_LOAD_GLFN(glGetActiveUniform);
        ASC_LOAD_GLFN(glGetAttachedShaders);
        ASC_LOAD_GLFN(glGetAttribLocation);
        ASC_LOAD_GLFN(glGetProgramiv);
        ASC_LOAD_GLFN(glGetProgramInfoLog);
        ASC_LOAD_GLFN(glGetShaderiv);
        ASC_LOAD_GLFN(glGetShaderInfoLog);
        ASC_LOAD_GLFN(glGetShaderSource);
        ASC_LOAD_GLFN(glGetUniformLocation);
        ASC_LOAD_GLFN(glGetUniformfv);
        ASC_LOAD_GLFN(glGetUniformiv);
        ASC_LOAD_GLFN(glGetVertexAttribdv);
        ASC_LOAD_GLFN(glGetVertexAttribfv);
        ASC_LOAD_GLFN(glGetVertexAttribiv);
        ASC_LOAD_GLFN(glGetVertexAttribPointerv);
        ASC_LOAD_GLFN(glIsProgram);
        ASC_LOAD_GLFN(glIsShader);
        ASC_LOAD_GLFN(glLinkProgram);
        ASC_LOAD_GLFN(glShaderSource);
        ASC_LOAD_GLFN(glUseProgram);
        ASC_LOAD_GLFN(glUniform1f);
        ASC_LOAD_GLFN(glUniform2f);
        ASC_LOAD_GLFN(glUniform3f);
        ASC_LOAD_GLFN(glUniform4f);
        ASC_LOAD_GLFN(glUniform1i);
        ASC_LOAD_GLFN(glUniform2i);
        ASC_LOAD_GLFN(glUniform3i);
        ASC_LOAD_GLFN(glUniform4i);
        ASC_LOAD_GLFN(glUniform1fv);
        ASC_LOAD_GLFN(glUniform2fv);
        ASC_LOAD_GLFN(glUniform3fv);
        ASC_LOAD_GLFN(glUniform4fv);
        ASC_LOAD_GLFN(glUniform1iv);
        ASC_LOAD_GLFN(glUniform2iv);
        ASC_LOAD_GLFN(glUniform3iv);
        ASC_LOAD_GLFN(glUniform4iv);
        ASC_LOAD_GLFN(glUniformMatrix2fv);
        ASC_LOAD_GLFN(glUniformMatrix3fv);
        ASC_LOAD_GLFN(glUniformMatrix4fv);
        ASC_LOAD_GLFN(glValidateProgram);
        ASC_LOAD_GLFN(glVertexAttrib1d);
        ASC_LOAD_GLFN(glVertexAttrib1dv);
        ASC_LOAD_GLFN(glVertexAttrib1f);
        ASC_LOAD_GLFN(glVertexAttrib1s);
        ASC_LOAD_GLFN(glVertexAttrib1sv);
        ASC_LOAD_GLFN(glVertexAttrib2d);
        ASC_LOAD_GLFN(glVertexAttrib2dv);
        ASC_LOAD_GLFN(glVertexAttrib2f);
        ASC_LOAD_GLFN(glVertexAttrib2fv);
        ASC_LOAD_GLFN(glVertexAttrib2s);
        ASC_LOAD_GLFN(glVertexAttrib2sv);
        ASC_LOAD_GLFN(glVertexAttrib3d);
        ASC_LOAD_GLFN(glVertexAttrib3dv);
        ASC_LOAD_GLFN(glVertexAttrib3f);
        ASC_LOAD_GLFN(glVertexAttrib3fv);
        ASC_LOAD_GLFN(glVertexAttrib3s);
        ASC_LOAD_GLFN(glVertexAttrib3sv);
        ASC_LOAD_GLFN(glVertexAttrib4Nbv);
        ASC_LOAD_GLFN(glVertexAttrib4Niv);
        ASC_LOAD_GLFN(glVertexAttrib4Nsv);
        ASC_LOAD_GLFN(glVertexAttrib4Nub);
        ASC_LOAD_GLFN(glVertexAttrib4Nubv);
        ASC_LOAD_GLFN(glVertexAttrib4Nuiv);
        ASC_LOAD_GLFN(glVertexAttrib4Nusv);
        ASC_LOAD_GLFN(glVertexAttrib4bv);
        ASC_LOAD_GLFN(glVertexAttrib4d);
        ASC_LOAD_GLFN(glVertexAttrib4dv);
        ASC_LOAD_GLFN(glVertexAttrib4f);
        ASC_LOAD_GLFN(glVertexAttrib4fv);
        ASC_LOAD_GLFN(glVertexAttrib4iv);
        ASC_LOAD_GLFN(glVertexAttrib4s);
        ASC_LOAD_GLFN(glVertexAttrib4sv);
        ASC_LOAD_GLFN(glVertexAttrib4ubv);
        ASC_LOAD_GLFN(glVertexAttrib4uiv);
        ASC_LOAD_GLFN(glVertexAttrib4usv);
        ASC_LOAD_GLFN(glVertexAttribPointer);
    }
    
    if(version >= 2.1)
    {
        ASC_LOAD_GLFN(glUniformMatrix2x3fv);
        ASC_LOAD_GLFN(glUniformMatrix3x2fv);
        ASC_LOAD_GLFN(glUniformMatrix2x4fv);
        ASC_LOAD_GLFN(glUniformMatrix4x2fv);
        ASC_LOAD_GLFN(glUniformMatrix3x4fv);
        ASC_LOAD_GLFN(glUniformMatrix4x3fv);
    }
    
    if(version >= 3.0)
    {
        ASC_LOAD_GLFN(glColorMaski);
        ASC_LOAD_GLFN(glGetBooleani_v);
        ASC_LOAD_GLFN(glGetIntegeri_v);
        ASC_LOAD_GLFN(glEnablei);
        ASC_LOAD_GLFN(glDisablei);
        ASC_LOAD_GLFN(glIsEnabledi);
        ASC_LOAD_GLFN(glBeginTransformFeedback);
        ASC_LOAD_GLFN(glEndTransformFeedback);
        ASC_LOAD_GLFN(glBindBufferRange);
        ASC_LOAD_GLFN(glBindBufferBase);
        ASC_LOAD_GLFN(glTransformFeedbackVaryings);
        ASC_LOAD_GLFN(glGetTransformFeedbackVarying);
        ASC_LOAD_GLFN(glClampColor);
        ASC_LOAD_GLFN(glBeginConditionalRender);
        ASC_LOAD_GLFN(glEndConditionalRender);
        ASC_LOAD_GLFN(glVertexAttribIPointer);
        ASC_LOAD_GLFN(glGetVertexAttribIiv);
        ASC_LOAD_GLFN(glGetVertexAttribIuiv);
        ASC_LOAD_GLFN(glVertexAttribI1i);
        ASC_LOAD_GLFN(glVertexAttribI2i);
        ASC_LOAD_GLFN(glVertexAttribI3i);
        ASC_LOAD_GLFN(glVertexAttribI4i);
        ASC_LOAD_GLFN(glVertexAttribI1ui);
        ASC_LOAD_GLFN(glVertexAttribI2ui);
        ASC_LOAD_GLFN(glVertexAttribI3ui);
        ASC_LOAD_GLFN(glVertexAttribI4ui);
        ASC_LOAD_GLFN(glVertexAttribI1iv);
        ASC_LOAD_GLFN(glVertexAttribI2iv);
        ASC_LOAD_GLFN(glVertexAttribI3iv);
        ASC_LOAD_GLFN(glVertexAttribI4iv);
        ASC_LOAD_GLFN(glVertexAttribI1uiv);
        ASC_LOAD_GLFN(glVertexAttribI2uiv);
        ASC_LOAD_GLFN(glVertexAttribI3uiv);
        ASC_LOAD_GLFN(glVertexAttribI4uiv);
        ASC_LOAD_GLFN(glVertexAttribI4bv);
        ASC_LOAD_GLFN(glVertexAttribI4sv);
        ASC_LOAD_GLFN(glVertexAttribI4ubv);
        ASC_LOAD_GLFN(glVertexAttribI4usv);
        ASC_LOAD_GLFN(glGetUniformuiv);
        ASC_LOAD_GLFN(glBindFragDataLocation);
        ASC_LOAD_GLFN(glGetFragDataLocation);
        ASC_LOAD_GLFN(glUniform1ui);
        ASC_LOAD_GLFN(glUniform2ui);
        ASC_LOAD_GLFN(glUniform3ui);
        ASC_LOAD_GLFN(glUniform4ui);
        ASC_LOAD_GLFN(glUniform1uiv);
        ASC_LOAD_GLFN(glUniform2uiv);
        ASC_LOAD_GLFN(glUniform3uiv);
        ASC_LOAD_GLFN(glUniform4uiv);
        ASC_LOAD_GLFN(glTexParameterIiv);
        ASC_LOAD_GLFN(glTexParameterIuiv);
        ASC_LOAD_GLFN(glGetTexParameterIiv);
        ASC_LOAD_GLFN(glGetTexParameterIuiv);
        ASC_LOAD_GLFN(glClearBufferiv);
        ASC_LOAD_GLFN(glClearBufferuiv);
        ASC_LOAD_GLFN(glClearBufferfv);
        ASC_LOAD_GLFN(glClearBufferfi);
        ASC_LOAD_GLFN(glGetStringi);
        ASC_LOAD_GLFN(glIsRenderbuffer);
        ASC_LOAD_GLFN(glBindRenderbuffer);
        ASC_LOAD_GLFN(glDeleteRenderbuffers);
        ASC_LOAD_GLFN(glGenRenderbuffers);
        ASC_LOAD_GLFN(glRenderbufferStorage);
        ASC_LOAD_GLFN(glGetRenderbufferParameteriv);
        ASC_LOAD_GLFN(glIsFramebuffer);
        ASC_LOAD_GLFN(glBindFramebuffer);
        ASC_LOAD_GLFN(glDeleteFramebuffers);
        ASC_LOAD_GLFN(glGenFramebuffers);
        ASC_LOAD_GLFN(glCheckFramebufferStatus);
        ASC_LOAD_GLFN(glFramebufferTexture1D);
        ASC_LOAD_GLFN(glFramebufferTexture2D);
        ASC_LOAD_GLFN(glFramebufferTexture3D);
        ASC_LOAD_GLFN(glFramebufferRenderbuffer);
        ASC_LOAD_GLFN(glGetFramebufferAttachmentParameteriv);
        ASC_LOAD_GLFN(glGenerateMipmap);
        ASC_LOAD_GLFN(glBlitFramebuffer);
        ASC_LOAD_GLFN(glRenderbufferStorageMultisample);
        ASC_LOAD_GLFN(glFramebufferTextureLayer);
        ASC_LOAD_GLFN(glMapBufferRange);
        ASC_LOAD_GLFN(glFlushMappedBufferRange);
        ASC_LOAD_GLFN(glBindVertexArray);
        ASC_LOAD_GLFN(glDeleteVertexArrays);
        ASC_LOAD_GLFN(glGenVertexArrays);
        ASC_LOAD_GLFN(glIsVertexArray);
    }
    
    if(version >= 3.1)
    {
        ASC_LOAD_GLFN(glDrawArraysInstanced);
        ASC_LOAD_GLFN(glDrawElementsInstanced);
        ASC_LOAD_GLFN(glTexBuffer);
        ASC_LOAD_GLFN(glPrimitiveRestartIndex);
        ASC_LOAD_GLFN(glCopyBufferSubData);
        ASC_LOAD_GLFN(glGetUniformIndices);
        ASC_LOAD_GLFN(glGetActiveUniformsiv);
        ASC_LOAD_GLFN(glGetActiveUniformName);
        ASC_LOAD_GLFN(glGetUniformBlockIndex);
        ASC_LOAD_GLFN(glGetActiveUniformBlockiv);
        ASC_LOAD_GLFN(glGetActiveUniformBlockName);
        ASC_LOAD_GLFN(glUniformBlockBinding);
    }
    
    if(version >= 3.2)
    {
        ASC_LOAD_GLFN(glDrawElementsBaseVertex);
        ASC_LOAD_GLFN(glDrawRangeElementsBaseVertex);
        ASC_LOAD_GLFN(glDrawElementsInstancedBaseVertex);
        ASC_LOAD_GLFN(glMultiDrawElementsBaseVertex);
        ASC_LOAD_GLFN(glProvokingVertex);
        ASC_LOAD_GLFN(glFenceSync);
        ASC_LOAD_GLFN(glIsSync);
        ASC_LOAD_GLFN(glDeleteSync);
        ASC_LOAD_GLFN(glClientWaitSync);
        ASC_LOAD_GLFN(glWaitSync);
        ASC_LOAD_GLFN(glGetInteger64v);
        ASC_LOAD_GLFN(glGetSynciv);
        ASC_LOAD_GLFN(glGetInteger64i_v);
        ASC_LOAD_GLFN(glGetBufferParameteri64v);
        ASC_LOAD_GLFN(glFramebufferTexture);
        ASC_LOAD_GLFN(glTexImage2DMultisample);
        ASC_LOAD_GLFN(glTexImage3DMultisample);
        ASC_LOAD_GLFN(glGetMultisamplefv);
        ASC_LOAD_GLFN(glSampleMaski);
    }
    
    if(version >= 3.3)
    {
        ASC_LOAD_GLFN(glBindFragDataLocationIndexed);
        ASC_LOAD_GLFN(glGetFragDataIndex);
        ASC_LOAD_GLFN(glGenSamplers);
        ASC_LOAD_GLFN(glDeleteSamplers);
        ASC_LOAD_GLFN(glIsSampler);
        ASC_LOAD_GLFN(glBindSampler);
        ASC_LOAD_GLFN(glSamplerParameteri);
        ASC_LOAD_GLFN(glSamplerParameteriv);
        ASC_LOAD_GLFN(glSamplerParameterf);
        ASC_LOAD_GLFN(glSamplerParameterfv);
        ASC_LOAD_GLFN(glSamplerParameterIiv);
        ASC_LOAD_GLFN(glSamplerParameterIuiv);
        ASC_LOAD_GLFN(glGetSamplerParameteriv);
        ASC_LOAD_GLFN(glGetSamplerParameterIiv);
        ASC_LOAD_GLFN(glGetSamplerParameterfv);
        ASC_LOAD_GLFN(glGetSamplerParameterIuiv);
        ASC_LOAD_GLFN(glQueryCounter);
        ASC_LOAD_GLFN(glGetQueryObjecti64v);
        ASC_LOAD_GLFN(glGetQueryObjectui64v);
        ASC_LOAD_GLFN(glVertexAttribDivisor);
        ASC_LOAD_GLFN(glVertexAttribP1ui);
        ASC_LOAD_GLFN(glVertexAttribP1uiv);
        ASC_LOAD_GLFN(glVertexAttribP2ui);
        ASC_LOAD_GLFN(glVertexAttribP2uiv);
        ASC_LOAD_GLFN(glVertexAttribP3ui);
        ASC_LOAD_GLFN(glVertexAttribP3uiv);
        ASC_LOAD_GLFN(glVertexAttribP4ui);
        ASC_LOAD_GLFN(glVertexAttribP4uiv);
        ASC_LOAD_GLFN(glVertexP2ui);
        ASC_LOAD_GLFN(glVertexP2uiv);
        ASC_LOAD_GLFN(glVertexP3ui);
        ASC_LOAD_GLFN(glVertexP3uiv);
        ASC_LOAD_GLFN(glVertexP4ui);
        ASC_LOAD_GLFN(glVertexP4uiv);
        ASC_LOAD_GLFN(glTexCoordP1ui);
        ASC_LOAD_GLFN(glTexCoordP1uiv);
        ASC_LOAD_GLFN(glTexCoordP2ui);
        ASC_LOAD_GLFN(glTexCoordP2uiv);
        ASC_LOAD_GLFN(glTexCoordP3ui);
        ASC_LOAD_GLFN(glTexCoordP3uiv);
        ASC_LOAD_GLFN(glTexCoordP4ui);
        ASC_LOAD_GLFN(glTexCoordP4uiv);
        ASC_LOAD_GLFN(glMultiTexCoordP1ui);
        ASC_LOAD_GLFN(glMultiTexCoordP1uiv);
        ASC_LOAD_GLFN(glMultiTexCoordP2ui);
        ASC_LOAD_GLFN(glMultiTexCoordP2uiv);
        ASC_LOAD_GLFN(glMultiTexCoordP3ui);
        ASC_LOAD_GLFN(glMultiTexCoordP3uiv);
        ASC_LOAD_GLFN(glMultiTexCoordP4ui);
        ASC_LOAD_GLFN(glMultiTexCoordP4uiv);
        ASC_LOAD_GLFN(glNormalP3ui);
        ASC_LOAD_GLFN(glNormalP3uiv);
        ASC_LOAD_GLFN(glColorP3ui);
        ASC_LOAD_GLFN(glColorP3uiv);
        ASC_LOAD_GLFN(glColorP4ui);
        ASC_LOAD_GLFN(glColorP4uiv);
        ASC_LOAD_GLFN(glSecondaryColorP3ui);
        ASC_LOAD_GLFN(glSecondaryColorP3uiv);
    }
    
    if(version >= 4.0)
    {
        ASC_LOAD_GLFN(glMinSampleShading);
        ASC_LOAD_GLFN(glBlendEquationi);
        ASC_LOAD_GLFN(glBlendEquationSeparatei);
        ASC_LOAD_GLFN(glBlendFunci);
        ASC_LOAD_GLFN(glBlendFuncSeparatei);
        ASC_LOAD_GLFN(glDrawArraysIndirect);
        ASC_LOAD_GLFN(glDrawElementsIndirect);
        ASC_LOAD_GLFN(glUniform1d);
        ASC_LOAD_GLFN(glUniform2d);
        ASC_LOAD_GLFN(glUniform3d);
        ASC_LOAD_GLFN(glUniform4d);
        ASC_LOAD_GLFN(glUniform1dv);
        ASC_LOAD_GLFN(glUniform2dv);
        ASC_LOAD_GLFN(glUniform3dv);
        ASC_LOAD_GLFN(glUniform4dv);
        ASC_LOAD_GLFN(glUniformMatrix2dv);
        ASC_LOAD_GLFN(glUniformMatrix3dv);
        ASC_LOAD_GLFN(glUniformMatrix4dv);
        ASC_LOAD_GLFN(glUniformMatrix2x3dv);
        ASC_LOAD_GLFN(glUniformMatrix2x4dv);
        ASC_LOAD_GLFN(glUniformMatrix3x2dv);
        ASC_LOAD_GLFN(glUniformMatrix3x4dv);
        ASC_LOAD_GLFN(glUniformMatrix4x2dv);
        ASC_LOAD_GLFN(glUniformMatrix4x3dv);
        ASC_LOAD_GLFN(glGetUniformdv);
        ASC_LOAD_GLFN(glGetSubroutineUniformLocation);
        ASC_LOAD_GLFN(glGetSubroutineIndex);
        ASC_LOAD_GLFN(glGetActiveSubroutineUniformiv);
        ASC_LOAD_GLFN(glGetActiveSubroutineUniformName);
        ASC_LOAD_GLFN(glGetActiveSubroutineName);
        ASC_LOAD_GLFN(glUniformSubroutinesuiv);
        ASC_LOAD_GLFN(glGetUniformSubroutineuiv);
        ASC_LOAD_GLFN(glGetProgramStageiv);
        ASC_LOAD_GLFN(glPatchParameteri);
        ASC_LOAD_GLFN(glPatchParameterfv);
        ASC_LOAD_GLFN(glBindTransformFeedback);
        ASC_LOAD_GLFN(glDeleteTransformFeedbacks);
        ASC_LOAD_GLFN(glGenTransformFeedbacks);
        ASC_LOAD_GLFN(glIsTransformFeedback);
        ASC_LOAD_GLFN(glPauseTransformFeedback);
        ASC_LOAD_GLFN(glResumeTransformFeedback);
        ASC_LOAD_GLFN(glDrawTransformFeedback);
        ASC_LOAD_GLFN(glDrawTransformFeedbackStream);
        ASC_LOAD_GLFN(glBeginQueryIndexed);
        ASC_LOAD_GLFN(glEndQueryIndexed);
        ASC_LOAD_GLFN(glGetQueryIndexediv);
    }
    
    if(version >= 4.1)
    {
        ASC_LOAD_GLFN(glReleaseShaderCompiler);
        ASC_LOAD_GLFN(glShaderBinary);
        ASC_LOAD_GLFN(glGetShaderPrecisionFormat);
        ASC_LOAD_GLFN(glDepthRangef);
        ASC_LOAD_GLFN(glClearDepthf);
        ASC_LOAD_GLFN(glGetProgramBinary);
        ASC_LOAD_GLFN(glProgramBinary);
        ASC_LOAD_GLFN(glProgramParameteri);
        ASC_LOAD_GLFN(glUseProgramStages);
        ASC_LOAD_GLFN(glActiveShaderProgram);
        ASC_LOAD_GLFN(glCreateShaderProgramv);
        ASC_LOAD_GLFN(glBindProgramPipeline);
        ASC_LOAD_GLFN(glDeleteProgramPipelines);
        ASC_LOAD_GLFN(glGenProgramPipelines);
        ASC_LOAD_GLFN(glIsProgramPipeline);
        ASC_LOAD_GLFN(glGetProgramPipelineiv);
        ASC_LOAD_GLFN(glProgramUniform1i);
        ASC_LOAD_GLFN(glProgramUniform1iv);
        ASC_LOAD_GLFN(glProgramUniform1f);
        ASC_LOAD_GLFN(glProgramUniform1fv);
        ASC_LOAD_GLFN(glProgramUniform1d);
        ASC_LOAD_GLFN(glProgramUniform1dv);
        ASC_LOAD_GLFN(glProgramUniform1ui);
        ASC_LOAD_GLFN(glProgramUniform1uiv);
        ASC_LOAD_GLFN(glProgramUniform2i);
        ASC_LOAD_GLFN(glProgramUniform2iv);
        ASC_LOAD_GLFN(glProgramUniform2f);
        ASC_LOAD_GLFN(glProgramUniform2fv);
        ASC_LOAD_GLFN(glProgramUniform2d);
        ASC_LOAD_GLFN(glProgramUniform2dv);
        ASC_LOAD_GLFN(glProgramUniform2ui);
        ASC_LOAD_GLFN(glProgramUniform2uiv);
        ASC_LOAD_GLFN(glProgramUniform3i);
        ASC_LOAD_GLFN(glProgramUniform3iv);
        ASC_LOAD_GLFN(glProgramUniform3f);
        ASC_LOAD_GLFN(glProgramUniform3fv);
        ASC_LOAD_GLFN(glProgramUniform3d);
        ASC_LOAD_GLFN(glProgramUniform3dv);
        ASC_LOAD_GLFN(glProgramUniform3ui);
        ASC_LOAD_GLFN(glProgramUniform3uiv);
        ASC_LOAD_GLFN(glProgramUniform4i);
        ASC_LOAD_GLFN(glProgramUniform4iv);
        ASC_LOAD_GLFN(glProgramUniform4f);
        ASC_LOAD_GLFN(glProgramUniform4fv);
        ASC_LOAD_GLFN(glProgramUniform4d);
        ASC_LOAD_GLFN(glProgramUniform4dv);
        ASC_LOAD_GLFN(glProgramUniform4ui);
        ASC_LOAD_GLFN(glProgramUniform4uiv);
        ASC_LOAD_GLFN(glProgramUniformMatrix2fv);
        ASC_LOAD_GLFN(glProgramUniformMatrix3fv);
        ASC_LOAD_GLFN(glProgramUniformMatrix4fv);
        ASC_LOAD_GLFN(glProgramUniformMatrix2dv);
        ASC_LOAD_GLFN(glProgramUniformMatrix3dv);
        ASC_LOAD_GLFN(glProgramUniformMatrix4dv);
        ASC_LOAD_GLFN(glProgramUniformMatrix2x3fv);
        ASC_LOAD_GLFN(glProgramUniformMatrix3x2fv);
        ASC_LOAD_GLFN(glProgramUniformMatrix2x4fv);
        ASC_LOAD_GLFN(glProgramUniformMatrix4x2fv);
        ASC_LOAD_GLFN(glProgramUniformMatrix3x4fv);
        ASC_LOAD_GLFN(glProgramUniformMatrix4x3fv);
        ASC_LOAD_GLFN(glProgramUniformMatrix2x3dv);
        ASC_LOAD_GLFN(glProgramUniformMatrix3x2dv);
        ASC_LOAD_GLFN(glProgramUniformMatrix2x4dv);
        ASC_LOAD_GLFN(glProgramUniformMatrix4x2dv);
        ASC_LOAD_GLFN(glProgramUniformMatrix3x4dv);
        ASC_LOAD_GLFN(glProgramUniformMatrix4x3dv);
        ASC_LOAD_GLFN(glValidateProgramPipeline);
        ASC_LOAD_GLFN(glGetProgramPipelineInfoLog);
        ASC_LOAD_GLFN(glVertexAttribL1d);
        ASC_LOAD_GLFN(glVertexAttribL2d);
        ASC_LOAD_GLFN(glVertexAttribL3d);
        ASC_LOAD_GLFN(glVertexAttribL4d);
        ASC_LOAD_GLFN(glVertexAttribL1dv);
        ASC_LOAD_GLFN(glVertexAttribL2dv);
        ASC_LOAD_GLFN(glVertexAttribL3dv);
        ASC_LOAD_GLFN(glVertexAttribL4dv);
        ASC_LOAD_GLFN(glVertexAttribLPointer);
        ASC_LOAD_GLFN(glGetVertexAttribLdv);
        ASC_LOAD_GLFN(glViewportArrayv);
        ASC_LOAD_GLFN(glViewportIndexedf);
        ASC_LOAD_GLFN(glViewportIndexedfv);
        ASC_LOAD_GLFN(glScissorArrayv);
        ASC_LOAD_GLFN(glScissorIndexed);
        ASC_LOAD_GLFN(glScissorIndexedv);
        ASC_LOAD_GLFN(glDepthRangeArrayv);
        ASC_LOAD_GLFN(glDepthRangeIndexed);
        ASC_LOAD_GLFN(glGetFloati_v);
        ASC_LOAD_GLFN(glGetDoublei_v);
    }
    
    if(version >= 4.2)
    {
        ASC_LOAD_GLFN(glDrawArraysInstancedBaseInstance);
        ASC_LOAD_GLFN(glDrawElementsInstancedBaseInstance);
        ASC_LOAD_GLFN(glDrawElementsInstancedBaseVertexBaseInstance);
        ASC_LOAD_GLFN(glGetInternalformativ);
        ASC_LOAD_GLFN(glGetActiveAtomicCounterBufferiv);
        ASC_LOAD_GLFN(glBindImageTexture);
        ASC_LOAD_GLFN(glMemoryBarrier);
        ASC_LOAD_GLFN(glTexStorage1D);
        ASC_LOAD_GLFN(glTexStorage2D);
        ASC_LOAD_GLFN(glTexStorage3D);
        ASC_LOAD_GLFN(glDrawTransformFeedbackInstanced);
        ASC_LOAD_GLFN(glDrawTransformFeedbackStreamInstanced);
    }
    
    if(version >= 4.3)
    {
        ASC_LOAD_GLFN(glClearBufferData);
        ASC_LOAD_GLFN(glClearBufferSubData);
        ASC_LOAD_GLFN(glDispatchCompute);
        ASC_LOAD_GLFN(glDispatchComputeIndirect);
        ASC_LOAD_GLFN(glCopyImageSubData);
        ASC_LOAD_GLFN(glFramebufferParameteri);
        ASC_LOAD_GLFN(glGetFramebufferParameteriv);
        ASC_LOAD_GLFN(glGetInternalformati64v);
        ASC_LOAD_GLFN(glInvalidateTexSubImage);
        ASC_LOAD_GLFN(glInvalidateTexImage);
        ASC_LOAD_GLFN(glInvalidateBufferSubData);
        ASC_LOAD_GLFN(glInvalidateBufferData);
        ASC_LOAD_GLFN(glInvalidateFramebuffer);
        ASC_LOAD_GLFN(glInvalidateSubFramebuffer);
        ASC_LOAD_GLFN(glMultiDrawArraysIndirect);
        ASC_LOAD_GLFN(glMultiDrawElementsIndirect);
        ASC_LOAD_GLFN(glGetProgramInterfaceiv);
        ASC_LOAD_GLFN(glGetProgramResourceIndex);
        ASC_LOAD_GLFN(glGetProgramResourceName);
        ASC_LOAD_GLFN(glGetProgramResourceiv);
        ASC_LOAD_GLFN(glGetProgramResourceLocation);
        ASC_LOAD_GLFN(glGetProgramResourceLocationIndex);
        ASC_LOAD_GLFN(glShaderStorageBlockBinding);
        ASC_LOAD_GLFN(glTexBufferRange);
        ASC_LOAD_GLFN(glTexStorage2DMultisample);
        ASC_LOAD_GLFN(glTexStorage3DMultisample);
        ASC_LOAD_GLFN(glTextureView);
        ASC_LOAD_GLFN(glBindVertexBuffer);
        ASC_LOAD_GLFN(glVertexAttribFormat);
        ASC_LOAD_GLFN(glVertexAttribIFormat);
        ASC_LOAD_GLFN(glVertexAttribLFormat);
        ASC_LOAD_GLFN(glVertexAttribBinding);
        ASC_LOAD_GLFN(glVertexBindingDivisor);
        ASC_LOAD_GLFN(glDebugMessageControl);
        ASC_LOAD_GLFN(glDebugMessageInsert);
        ASC_LOAD_GLFN(glDebugMessageCallback);
        ASC_LOAD_GLFN(glGetDebugMessageLog);
        ASC_LOAD_GLFN(glPushDebugGroup);
        ASC_LOAD_GLFN(glPopDebugGroup);
        ASC_LOAD_GLFN(glObjectLabel);
        ASC_LOAD_GLFN(glGetObjectLabel);
        ASC_LOAD_GLFN(glObjectPtrLabel);
        ASC_LOAD_GLFN(glGetObjectPtrLabel);
    }
    
    if(version >= 4.4)
    {
        ASC_LOAD_GLFN(glBufferStorage);
        ASC_LOAD_GLFN(glClearTexImage);
        ASC_LOAD_GLFN(glClearTexSubImage);
        ASC_LOAD_GLFN(glBindBuffersBase);
        ASC_LOAD_GLFN(glBindBuffersRange);
        ASC_LOAD_GLFN(glBindTextures);
        ASC_LOAD_GLFN(glBindSamplers);
        ASC_LOAD_GLFN(glBindImageTextures);
        ASC_LOAD_GLFN(glBindVertexBuffers);
    }
    
    if(version >= 4.5)
    {
        ASC_LOAD_GLFN(glClipControl);
        ASC_LOAD_GLFN(glCreateTransformFeedbacks);
        ASC_LOAD_GLFN(glTransformFeedbackBufferBase);
        ASC_LOAD_GLFN(glTransformFeedbackBufferRange);
        ASC_LOAD_GLFN(glGetTransformFeedbackiv);
        ASC_LOAD_GLFN(glGetTransformFeedbacki_v);
        ASC_LOAD_GLFN(glGetTransformFeedbacki64_v);
        ASC_LOAD_GLFN(glCreateBuffers);
        ASC_LOAD_GLFN(glNamedBufferStorage);
        ASC_LOAD_GLFN(glNamedBufferData);
        ASC_LOAD_GLFN(glNamedBufferSubData);
        ASC_LOAD_GLFN(glCopyNamedBufferSubData);
        ASC_LOAD_GLFN(glClearNamedBufferData);
        ASC_LOAD_GLFN(glClearNamedBufferSubData);
        ASC_LOAD_GLFN(glMapNamedBuffer);
        ASC_LOAD_GLFN(glMapNamedBufferRange);
        ASC_LOAD_GLFN(glUnmapNamedBuffer);
        ASC_LOAD_GLFN(glFlushMappedNamedBufferRange);
        ASC_LOAD_GLFN(glGetNamedBufferParameteriv);
        ASC_LOAD_GLFN(glGetNamedBufferParameteri64v);
        ASC_LOAD_GLFN(glGetNamedBufferPointerv);
        ASC_LOAD_GLFN(glGetNamedBufferSubData);
        ASC_LOAD_GLFN(glCreateFramebuffers);
        ASC_LOAD_GLFN(glNamedFramebufferRenderbuffer);
        ASC_LOAD_GLFN(glNamedFramebufferParameteri);
        ASC_LOAD_GLFN(glNamedFramebufferTexture);
        ASC_LOAD_GLFN(glNamedFramebufferTextureLayer);
        ASC_LOAD_GLFN(glNamedFramebufferDrawBuffer);
        ASC_LOAD_GLFN(glNamedFramebufferDrawBuffers);
        ASC_LOAD_GLFN(glNamedFramebufferReadBuffer);
        ASC_LOAD_GLFN(glInvalidateNamedFramebufferData);
        ASC_LOAD_GLFN(glInvalidateNamedFramebufferSubData);
        ASC_LOAD_GLFN(glClearNamedFramebufferiv);
        ASC_LOAD_GLFN(glClearNamedFramebufferuiv);
        ASC_LOAD_GLFN(glClearNamedFramebufferfv);
        ASC_LOAD_GLFN(glClearNamedFramebufferfi);
        ASC_LOAD_GLFN(glBlitNamedFramebuffer);
        ASC_LOAD_GLFN(glCheckNamedFramebufferStatus);
        ASC_LOAD_GLFN(glGetNamedFramebufferParameteriv);
        ASC_LOAD_GLFN(glGetNamedFramebufferAttachmentParameteriv);
        ASC_LOAD_GLFN(glCreateRenderbuffers);
        ASC_LOAD_GLFN(glNamedRenderbufferStorage);
        ASC_LOAD_GLFN(glNamedRenderbufferStorageMultisample);
        ASC_LOAD_GLFN(glGetNamedRenderbufferParameteriv);
        ASC_LOAD_GLFN(glCreateTextures);
        ASC_LOAD_GLFN(glTextureBuffer);
        ASC_LOAD_GLFN(glTextureBufferRange);
        ASC_LOAD_GLFN(glTextureStorage1D);
        ASC_LOAD_GLFN(glTextureStorage2D);
        ASC_LOAD_GLFN(glTextureStorage3D);
        ASC_LOAD_GLFN(glTextureStorage2DMultisample);
        ASC_LOAD_GLFN(glTextureStorage3DMultisample);
        ASC_LOAD_GLFN(glTextureSubImage1D);
        ASC_LOAD_GLFN(glTextureSubImage2D);
        ASC_LOAD_GLFN(glTextureSubImage3D);
        ASC_LOAD_GLFN(glCompressedTextureSubImage1D);
        ASC_LOAD_GLFN(glCompressedTextureSubImage2D);
        ASC_LOAD_GLFN(glCompressedTextureSubImage3D);
        ASC_LOAD_GLFN(glCopyTextureSubImage1D);
        ASC_LOAD_GLFN(glCopyTextureSubImage2D);
        ASC_LOAD_GLFN(glCopyTextureSubImage3D);
        ASC_LOAD_GLFN(glTextureParameterf);
        ASC_LOAD_GLFN(glTextureParameterfv);
        ASC_LOAD_GLFN(glTextureParameteri);
        ASC_LOAD_GLFN(glTextureParameterIiv);
        ASC_LOAD_GLFN(glTextureParameterIuiv);
        ASC_LOAD_GLFN(glTextureParameteriv);
        ASC_LOAD_GLFN(glGenerateTextureMipmap);
        ASC_LOAD_GLFN(glBindTextureUnit);
        ASC_LOAD_GLFN(glGetTextureImage);
        ASC_LOAD_GLFN(glGetCompressedTextureImage);
        ASC_LOAD_GLFN(glGetTextureLevelParameterfv);
        ASC_LOAD_GLFN(glGetTextureLevelParameteriv);
        ASC_LOAD_GLFN(glGetTextureParameterfv);
        ASC_LOAD_GLFN(glGetTextureParameterIiv);
        ASC_LOAD_GLFN(glGetTextureParameterIuiv);
        ASC_LOAD_GLFN(glGetTextureParameteriv);
        ASC_LOAD_GLFN(glCreateVertexArrays);
        ASC_LOAD_GLFN(glDisableVertexArrayAttrib);
        ASC_LOAD_GLFN(glEnableVertexArrayAttrib);
        ASC_LOAD_GLFN(glVertexArrayElementBuffer);
        ASC_LOAD_GLFN(glVertexArrayVertexBuffer);
        ASC_LOAD_GLFN(glVertexArrayVertexBuffers);
        ASC_LOAD_GLFN(glVertexArrayAttribBinding);
        ASC_LOAD_GLFN(glVertexArrayAttribFormat);
        ASC_LOAD_GLFN(glVertexArrayAttribIFormat);
        ASC_LOAD_GLFN(glVertexArrayAttribLFormat);
        ASC_LOAD_GLFN(glVertexArrayBindingDivisor);
        ASC_LOAD_GLFN(glGetVertexArrayiv);
        ASC_LOAD_GLFN(glGetVertexArrayIndexediv);
        ASC_LOAD_GLFN(glGetVertexArrayIndexed64iv);
        ASC_LOAD_GLFN(glCreateSamplers);
        ASC_LOAD_GLFN(glCreateProgramPipelines);
        ASC_LOAD_GLFN(glCreateQueries);
        ASC_LOAD_GLFN(glGetQueryBufferObjecti64v);
        ASC_LOAD_GLFN(glGetQueryBufferObjectiv);
        ASC_LOAD_GLFN(glGetQueryBufferObjectui64v);
        ASC_LOAD_GLFN(glGetQueryBufferObjectuiv);
        ASC_LOAD_GLFN(glMemoryBarrierByRegion);
        ASC_LOAD_GLFN(glGetTextureSubImage);
        ASC_LOAD_GLFN(glGetCompressedTextureSubImage);
        ASC_LOAD_GLFN(glGetGraphicsResetStatus);
        ASC_LOAD_GLFN(glGetnCompressedTexImage);
        ASC_LOAD_GLFN(glGetnTexImage);
        ASC_LOAD_GLFN(glGetnUniformdv);
        ASC_LOAD_GLFN(glGetnUniformfv);
        ASC_LOAD_GLFN(glGetnUniformiv);
        ASC_LOAD_GLFN(glGetnUniformuiv);
        ASC_LOAD_GLFN(glReadnPixels);
        ASC_LOAD_GLFN(glGetnMapdv);
        ASC_LOAD_GLFN(glGetnMapfv);
        ASC_LOAD_GLFN(glGetnMapiv);
        ASC_LOAD_GLFN(glGetnPixelMapfv);
        ASC_LOAD_GLFN(glGetnPixelMapuiv);
        ASC_LOAD_GLFN(glGetnPixelMapusv);
        ASC_LOAD_GLFN(glGetnPolygonStipple);
        ASC_LOAD_GLFN(glGetnColorTable);
        ASC_LOAD_GLFN(glGetnConvolutionFilter);
        ASC_LOAD_GLFN(glGetnSeparableFilter);
        ASC_LOAD_GLFN(glGetnHistogram);
        ASC_LOAD_GLFN(glGetnMinmax);
        ASC_LOAD_GLFN(glTextureBarrier);
    }
