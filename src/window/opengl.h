...
#ifndef ASCENCIA_WINDOW_OPENGL_H
#define ASCENCIA_WINDOW_OPENGL_H
...
typedef void (*pfn_glTexImage1D)(GLenum target, GLint level, GLint internalformat, GLsizei width, GLint border, GLenum format, GLenum type, const ptr pixels);
pfn_glTexImage1D glTexImage1D;
typedef void (*pfn_glTexImage2D)(GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type, const ptr pixels);
...
typedef void (*pfn_glReadPixels)(GLint x, GLint y, GLsizei width, GLsizei height, GLenum format, GLenum type, ptr pixels);
...
typedef void (*pfn_glGetTexImage)(GLenum target, GLint level, GLenum format, GLenum type, ptr pixels);
...
typedef void (*pfn_glDrawElements)(GLenum mode, GLsizei count, GLenum type, const ptr indices);
...
typedef void (*pfn_glTexSubImage1D)(GLenum target, GLint level, GLint xoffset, GLsizei width, GLenum format, GLenum type, const ptr pixels);
pfn_glTexSubImage1D glTexSubImage1D;
typedef void (*pfn_glTexSubImage2D)(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLenum type, const ptr pixels);
...
// GL 1.2
typedef void (*pfn_glDrawRangeElements)(GLenum mode, GLuint start, GLuint end, GLsizei count, GLenum type, const ptr indices);
pfn_glDrawRangeElements glDrawRangeElements;
typedef void (*pfn_glTexImage3D)(GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLenum format, GLenum type, const ptr pixels);
pfn_glTexImage3D glTexImage3D;
typedef void (*pfn_glTexSubImage3D)(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLenum type, const ptr pixels);
...
typedef void (*pfn_glCompressedTexImage3D)(GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLsizei imageSize, const ptr data);
pfn_glCompressedTexImage3D glCompressedTexImage3D;
typedef void (*pfn_glCompressedTexImage2D)(GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLint border, GLsizei imageSize, const ptr data);
pfn_glCompressedTexImage2D glCompressedTexImage2D;
typedef void (*pfn_glCompressedTexImage1D)(GLenum target, GLint level, GLenum internalformat, GLsizei width, GLint border, GLsizei imageSize, const ptr data);
pfn_glCompressedTexImage1D glCompressedTexImage1D;
typedef void (*pfn_glCompressedTexSubImage3D)(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLsizei imageSize, const ptr data);
pfn_glCompressedTexSubImage3D glCompressedTexSubImage3D;
typedef void (*pfn_glCompressedTexSubImage2D)(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLsizei imageSize, const ptr data);
pfn_glCompressedTexSubImage2D glCompressedTexSubImage2D;
typedef void (*pfn_glCompressedTexSubImage1D)(GLenum target, GLint level, GLint xoffset, GLsizei width, GLenum format, GLsizei imageSize, const ptr data);
pfn_glCompressedTexSubImage1D glCompressedTexSubImage1D;
typedef void (*pfn_glGetCompressedTexImage)(GLenum target, GLint level, ptr img);
...
typedef void (*pfn_glMultiDrawElements)(GLenum mode, const GLsizei *count, GLenum type, const ptr const *indices, GLsizei drawcount);
...
typedef void (*pfn_glBufferData)(GLenum target, GLsizeiptr size, const ptr data, GLenum usage);
pfn_glBufferData glBufferData;
typedef void (*pfn_glBufferSubData)(GLenum target, GLintptr offset, GLsizeiptr size, const ptr data);
pfn_glBufferSubData glBufferSubData;
typedef void (*pfn_glGetBufferSubData)(GLenum target, GLintptr offset, GLsizeiptr size, ptr data);
pfn_glGetBufferSubData glGetBufferSubData;
typedef ptr (*pfn_glMapBuffer)(GLenum target, GLenum access);
...
typedef void (*pfn_glGetBufferPointerv)(GLenum target, GLenum pname, ptr *params);
...
typedef void (*pfn_glGetVertexAttribPointerv)(GLuint index, GLenum pname, ptr *pointer);
...
typedef void (*pfn_glVertexAttribPointer)(GLuint index, GLint size, GLenum type, GLboolean normalized, GLsizei stride, const ptr pointer);
...
typedef void (*pfn_glVertexAttribIPointer)(GLuint index, GLint size, GLenum type, GLsizei stride, const ptr pointer);
...
typedef ptr (*pfn_glMapBufferRange)(GLenum target, GLintptr offset, GLsizeiptr length, GLbitfield access);
...
typedef void (*pfn_glDrawElementsInstanced)(GLenum mode, GLsizei count, GLenum type, const ptr indices, GLsizei instancecount);
...
// GL 3.2
typedef void (*pfn_glDrawElementsBaseVertex)(GLenum mode, GLsizei count, GLenum type, const ptr indices, GLint basevertex);
pfn_glDrawElementsBaseVertex glDrawElementsBaseVertex;
typedef void (*pfn_glDrawRangeElementsBaseVertex)(GLenum mode, GLuint start, GLuint end, GLsizei count, GLenum type, const ptr indices, GLint basevertex);
pfn_glDrawRangeElementsBaseVertex glDrawRangeElementsBaseVertex;
typedef void (*pfn_glDrawElementsInstancedBaseVertex)(GLenum mode, GLsizei count, GLenum type, const ptr indices, GLsizei instancecount, GLint basevertex);
pfn_glDrawElementsInstancedBaseVertex glDrawElementsInstancedBaseVertex;
typedef void (*pfn_glMultiDrawElementsBaseVertex)(GLenum mode, const GLsizei *count, GLenum type, const ptr const *indices, GLsizei drawcount, const GLint *basevertex);
...
typedef void (*pfn_glDrawArraysIndirect)(GLenum mode, const ptr indirect);
pfn_glDrawArraysIndirect glDrawArraysIndirect;
typedef void (*pfn_glDrawElementsIndirect)(GLenum mode, GLenum type, const ptr indirect);
...
typedef void (*pfn_glShaderBinary)(GLsizei count, const GLuint *shaders, GLenum binaryFormat, const ptr binary, GLsizei length);
...
typedef void (*pfn_glGetProgramBinary)(GLuint program, GLsizei bufSize, GLsizei *length, GLenum *binaryFormat, ptr binary);
pfn_glGetProgramBinary glGetProgramBinary;
typedef void (*pfn_glProgramBinary)(GLuint program, GLenum binaryFormat, const ptr binary, GLsizei length);
...
typedef void (*pfn_glVertexAttribLPointer)(GLuint index, GLint size, GLenum type, GLsizei stride, const ptr pointer);
...
typedef void (*pfn_glDrawElementsInstancedBaseInstance)(GLenum mode, GLsizei count, GLenum type, const ptr indices, GLsizei instancecount, GLuint baseinstance);
pfn_glDrawElementsInstancedBaseInstance glDrawElementsInstancedBaseInstance;
typedef void (*pfn_glDrawElementsInstancedBaseVertexBaseInstance)(GLenum mode, GLsizei count, GLenum type, const ptr indices, GLsizei instancecount, GLint basevertex, GLuint baseinstance);
...
// GL 4.3
typedef void (*pfn_glClearBufferData)(GLenum target, GLenum internalformat, GLenum format, GLenum type, const ptr data);
pfn_glClearBufferData glClearBufferData;
typedef void (*pfn_glClearBufferSubData)(GLenum target, GLenum internalformat, GLintptr offset, GLsizeiptr size, GLenum format, GLenum type, const ptr data);
...
typedef void (*pfn_glMultiDrawArraysIndirect)(GLenum mode, const ptr indirect, GLsizei drawcount, GLsizei stride);
pfn_glMultiDrawArraysIndirect glMultiDrawArraysIndirect;
typedef void (*pfn_glMultiDrawElementsIndirect)(GLenum mode, GLenum type, const ptr indirect, GLsizei drawcount, GLsizei stride);
...
typedef void (*pfn_glDebugMessageCallback)(GLDEBUGPROC callback, const ptr userParam);
...
typedef void (*pfn_glObjectPtrLabel)(const ptr ptr, GLsizei length, const GLchar *label);
pfn_glObjectPtrLabel glObjectPtrLabel;
typedef void (*pfn_glGetObjectPtrLabel)(const ptr ptr, GLsizei bufSize, GLsizei *length, GLchar *label);
pfn_glGetObjectPtrLabel glGetObjectPtrLabel;

// GL 4.4
typedef void (*pfn_glBufferStorage)(GLenum target, GLsizeiptr size, const ptr data, GLbitfield flags);
pfn_glBufferStorage glBufferStorage;
typedef void (*pfn_glClearTexImage)(GLuint texture, GLint level, GLenum format, GLenum type, const ptr data);
pfn_glClearTexImage glClearTexImage;
typedef void (*pfn_glClearTexSubImage)(GLuint texture, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLenum type, const ptr data);
...
typedef void (*pfn_glNamedBufferStorage)(GLuint buffer, GLsizeiptr size, const ptr data, GLbitfield flags);
pfn_glNamedBufferStorage glNamedBufferStorage;
typedef void (*pfn_glNamedBufferData)(GLuint buffer, GLsizeiptr size, const ptr data, GLenum usage);
pfn_glNamedBufferData glNamedBufferData;
typedef void (*pfn_glNamedBufferSubData)(GLuint buffer, GLintptr offset, GLsizeiptr size, const ptr data);
...
typedef void (*pfn_glClearNamedBufferData)(GLuint buffer, GLenum internalformat, GLenum format, GLenum type, const ptr data);
pfn_glClearNamedBufferData glClearNamedBufferData;
typedef void (*pfn_glClearNamedBufferSubData)(GLuint buffer, GLenum internalformat, GLintptr offset, GLsizeiptr size, GLenum format, GLenum type, const ptr data);
pfn_glClearNamedBufferSubData glClearNamedBufferSubData;
typedef ptr (*pfn_glMapNamedBuffer)(GLuint buffer, GLenum access);
pfn_glMapNamedBuffer glMapNamedBuffer;
typedef ptr (*pfn_glMapNamedBufferRange)(GLuint buffer, GLintptr offset, GLsizeiptr length, GLbitfield access);
...
typedef void (*pfn_glGetNamedBufferPointerv)(GLuint buffer, GLenum pname, ptr *params);
pfn_glGetNamedBufferPointerv glGetNamedBufferPointerv;
typedef void (*pfn_glGetNamedBufferSubData)(GLuint buffer, GLintptr offset, GLsizeiptr size, ptr data);
...
typedef void (*pfn_glTextureSubImage1D)(GLuint texture, GLint level, GLint xoffset, GLsizei width, GLenum format, GLenum type, const ptr pixels);
pfn_glTextureSubImage1D glTextureSubImage1D;
typedef void (*pfn_glTextureSubImage2D)(GLuint texture, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLenum type, const ptr pixels);
pfn_glTextureSubImage2D glTextureSubImage2D;
typedef void (*pfn_glTextureSubImage3D)(GLuint texture, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLenum type, const ptr pixels);
pfn_glTextureSubImage3D glTextureSubImage3D;
typedef void (*pfn_glCompressedTextureSubImage1D)(GLuint texture, GLint level, GLint xoffset, GLsizei width, GLenum format, GLsizei imageSize, const ptr data);
pfn_glCompressedTextureSubImage1D glCompressedTextureSubImage1D;
typedef void (*pfn_glCompressedTextureSubImage2D)(GLuint texture, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLsizei imageSize, const ptr data);
pfn_glCompressedTextureSubImage2D glCompressedTextureSubImage2D;
typedef void (*pfn_glCompressedTextureSubImage3D)(GLuint texture, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLsizei imageSize, const ptr data);
...
typedef void (*pfn_glGetTextureImage)(GLuint texture, GLint level, GLenum format, GLenum type, GLsizei bufSize, ptr pixels);
pfn_glGetTextureImage glGetTextureImage;
typedef void (*pfn_glGetCompressedTextureImage)(GLuint texture, GLint level, GLsizei bufSize, ptr pixels);
...
typedef void (*pfn_glGetTextureSubImage)(GLuint texture, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLenum type, GLsizei bufSize, ptr pixels);
pfn_glGetTextureSubImage glGetTextureSubImage;
typedef void (*pfn_glGetCompressedTextureSubImage)(GLuint texture, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLsizei bufSize, ptr pixels);
...
typedef void (*pfn_glGetnCompressedTexImage)(GLenum target, GLint lod, GLsizei bufSize, ptr pixels);
pfn_glGetnCompressedTexImage glGetnCompressedTexImage;
typedef void (*pfn_glGetnTexImage)(GLenum target, GLint level, GLenum format, GLenum type, GLsizei bufSize, ptr pixels);
...
typedef void (*pfn_glReadnPixels)(GLint x, GLint y, GLsizei width, GLsizei height, GLenum format, GLenum type, GLsizei bufSize, ptr data);
...
typedef void (*pfn_glGetnColorTable)(GLenum target, GLenum format, GLenum type, GLsizei bufSize, ptr table);
pfn_glGetnColorTable glGetnColorTable;
typedef void (*pfn_glGetnConvolutionFilter)(GLenum target, GLenum format, GLenum type, GLsizei bufSize, ptr image);
pfn_glGetnConvolutionFilter glGetnConvolutionFilter;
typedef void (*pfn_glGetnSeparableFilter)(GLenum target, GLenum format, GLenum type, GLsizei rowBufSize, ptr row, GLsizei columnBufSize, ptr column, ptr span);
pfn_glGetnSeparableFilter glGetnSeparableFilter;
typedef void (*pfn_glGetnHistogram)(GLenum target, GLboolean reset, GLenum format, GLenum type, GLsizei bufSize, ptr values);
pfn_glGetnHistogram glGetnHistogram;
typedef void (*pfn_glGetnMinmax)(GLenum target, GLboolean reset, GLenum format, GLenum type, GLsizei bufSize, ptr values);
pfn_glGetnMinmax glGetnMinmax;
typedef void (*pfn_glTextureBarrier)(void);
pfn_glTextureBarrier glTextureBarrier;

#endif /* ASCENCIA_WINDOW_OPENGL_H */